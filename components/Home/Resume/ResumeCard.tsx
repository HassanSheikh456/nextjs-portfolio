        ...
        <div className='flex-1'>
          {date && (
            <h1 className='mb-2 sm:px-6 sm:py-1.5 px-4 py-1 rounded-full bg-gray-200
             text-gray-600 w-fit sm:text-lg text-sm font-bold'>{date}</h1>
          )}
          <h1 className='text-gray-200 text-xl sm:text-2xl font-semibold'>{role}</h1>
          <p className='text-gray-300 text-sm sm:text-base pt-3'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. At veniam sapiente pariatur vel recusandae!</p>
        </div>
      </div>
    </div>
  )
